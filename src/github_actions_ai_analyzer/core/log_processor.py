...
class LogProcessor:
    ...
    def _create_log_entry(self, line: str, line_num: int) -> Optional[LogEntry]:
        """ログエントリを作成"""
        # タイムスタンプを抽出
    ...
    def filter_by_level(self, entries: List[LogEntry], min_level: LogLevel) -> List[LogEntry]:
    ...
    def group_by_step(self, entries: List[LogEntry]) -> Dict[str, List[LogEntry]]:
        """ステップごとにログエントリをグループ化"""
        grouped = {}
